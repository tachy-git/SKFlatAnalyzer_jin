        ...
        if self.channel == "MeasNormMu":
            ...
            if event.PassTrigger("HLT_Mu8_TrkIsoVVL_v"):
                ...
                for idx, mu in enumerate(looseMuons, start=1):
                    super().FillHist(f"{self.channel}_{trigSuffix}/loose/{syst}/muons/{idx}/pt", mu.Pt(), weight, 300, 0., 300.)
                    super().FillHist(f"{self.channel}_{trigSuffix}/loose/{syst}/muons/{idx}/eta", mu.Eta(), weight, 48, -2.4, 2.4)
                    super().FillHist(f"{self.channel}_{trigSuffix}/loose/{syst}/muons/{idx}/phi", mu.Phi(), weight, 64, -3.2, 3.2)
                    super().FillHist(f"{self.channel}_{trigSuffix}/loose/{syst}/muons/{idx}/mass", mu.M(), weight, 10, 0., 1.)
                for idx, jet in enumerate(jets, start=1):
                    super().FillHist(f"{self.channel}_{trigSuffix}/loose/{syst}/jets/{idx}/pt", jet.Pt(), weight, 300, 0., 300.)
                    super().FillHist(f"{self.channel}_{trigSuffix}/loose/{syst}/jets/{idx}/eta", jet.Eta(), weight, 48, -2.4, 2.4)
                    super().FillHist(f"{self.channel}_{trigSuffix}/loose/{syst}/jets/{idx}/phi", jet.Phi(), weight, 64, -3.2, 3.2)
                    super().FillHist(f"{self.channel}_{trigSuffix}/loose/{syst}/jets/{idx}/mass", jet.M(), weight, 100, 0., 100.)
                for idx, bjet in enumerate(bjets, start=1):
                    super().FillHist(f"{self.channel}_{trigSuffix}/loose/{syst}/bjets/{idx}/pt", bjet.Pt(), weight, 300, 0., 300.)
                    super().FillHist(f"{self.channel}_{trigSuffix}/loose/{syst}/bjets/{idx}/eta", bjet.Eta(), weight, 48, -2.4, 2.4)
                    super().FillHist(f"{self.channel}_{trigSuffix}/loose/{syst}/bjets/{idx}/phi", bjet.Phi(), weight, 64, -3.2, 3.2)
                    super().FillHist(f"{self.channel}_{trigSuffix}/loose/{syst}/bjets/{idx}/mass", bjet.M(), weight, 100, 0., 100.)
                super().FillHist(f"{self.channel}_{trigSuffix}/loose/{syst}/jets/size", jets.size(), weight, 20, 0., 20.)
                super().FillHist(f"{self.channel}_{trigSuffix}/loose/{syst}/bjets/size", bjets.size(), weight, 15, 0., 15.)
                super().FillHist(f"{self.channel}_{trigSuffix}/loose/{syst}/METv/pt", METv.Pt(), weight, 300, 0., 300.)
                super().FillHist(f"{self.channel}_{trigSuffix}/loose/{syst}/pair/pt", pair.Pt(), weight, 300, 0., 300.)
                super().FillHist(f"{self.channel}_{trigSuffix}/loose/{syst}/pair/eta", pair.Eta(), weight, 100, -5., 5.)
                super().FillHist(f"{self.channel}_{trigSuffix}/loose/{syst}/pair/phi", pair.Phi(), weight, 64, -3.2, 3.2)
                super().FillHist(f"{self.channel}_{trigSuffix}/loose/{syst}/pair/mass", pair.M(), weight, 80, 50., 130.)
            ...
            if event.PassTrigger("HLT_Mu8_TrkIsoVVL_v"):
                trigSuffix = "Mu8"
                for idx, mu in enumerate(looseMuons, start=1):
                    super().FillHist(f"{self.channel}_{trigSuffix}/tight/{syst}/muons/{idx}/pt", mu.Pt(), weight, 300, 0., 300.)
                    super().FillHist(f"{self.channel}_{trigSuffix}/tight/{syst}/muons/{idx}/eta", mu.Eta(), weight, 48, -2.4, 2.4)
                    super().FillHist(f"{self.channel}_{trigSuffix}/tight/{syst}/muons/{idx}/phi", mu.Phi(), weight, 64, -3.2, 3.2)
                    super().FillHist(f"{self.channel}_{trigSuffix}/tight/{syst}/muons/{idx}/mass", mu.M(), weight, 10, 0., 1.)
                for idx, jet in enumerate(jets, start=1):
                    super().FillHist(f"{self.channel}_{trigSuffix}/tight/{syst}/jets/{idx}/pt", jet.Pt(), weight, 300, 0., 300.)
                    super().FillHist(f"{self.channel}_{trigSuffix}/tight/{syst}/jets/{idx}/eta", jet.Eta(), weight, 48, -2.4, 2.4)
                    super().FillHist(f"{self.channel}_{trigSuffix}/tight/{syst}/jets/{idx}/phi", jet.Phi(), weight, 64, -3.2, 3.2)
                    super().FillHist(f"{self.channel}_{trigSuffix}/tight/{syst}/jets/{idx}/mass", jet.M(), weight, 100, 0., 100.)
                for idx, bjet in enumerate(bjets, start=1):
                    super().FillHist(f"{self.channel}_{trigSuffix}/tight/{syst}/bjets/{idx}/pt", bjet.Pt(), weight, 300, 0., 300.)
                    super().FillHist(f"{self.channel}_{trigSuffix}/tight/{syst}/bjets/{idx}/eta", bjet.Eta(), weight, 48, -2.4, 2.4)
                    super().FillHist(f"{self.channel}_{trigSuffix}/tight/{syst}/bjets/{idx}/phi", bjet.Phi(), weight, 64, -3.2, 3.2)
                    super().FillHist(f"{self.channel}_{trigSuffix}/tight/{syst}/bjets/{idx}/mass", bjet.M(), weight, 100, 0., 100.)
                super().FillHist(f"{self.channel}_{trigSuffix}/tight/{syst}/jets/size", jets.size(), weight, 20, 0., 20.)
                super().FillHist(f"{self.channel}_{trigSuffix}/tight/{syst}/bjets/size", bjets.size(), weight, 15, 0., 15.)
                super().FillHist(f"{self.channel}_{trigSuffix}/tight/{syst}/METv/pt", METv.Pt(), weight, 300, 0., 300.)
                super().FillHist(f"{self.channel}_{trigSuffix}/tight/{syst}/pair/pt", pair.Pt(), weight, 300, 0., 300.)
                super().FillHist(f"{self.channel}_{trigSuffix}/tight/{syst}/pair/eta", pair.Eta(), weight, 100, -5., 5.)
                super().FillHist(f"{self.channel}_{trigSuffix}/tight/{syst}/pair/phi", pair.Phi(), weight, 64, -3.2, 3.2)
                super().FillHist(f"{self.channel}_{trigSuffix}/tight/{syst}/pair/mass", pair.M(), weight, 80, 50., 130.)
        ...
        if self.channel == "MeasNormEl":
            ...
            if event.PassTrigger("HLT_Ele8_CaloIdL_TrackIdL_IsoVL_PFJet30_v"):
                ...
                for idx, mu in enumerate(looseElectrons, start=1):
                    super().FillHist(f"{self.channel}_{trigSuffix}/loose/{syst}/electrons/{idx}/pt", mu.Pt(), weight, 300, 0., 300.)
                    super().FillHist(f"{self.channel}_{trigSuffix}/loose/{syst}/electrons/{idx}/eta", mu.Eta(), weight, 48, -2.4, 2.4)
                    super().FillHist(f"{self.channel}_{trigSuffix}/loose/{syst}/electrons/{idx}/phi", mu.Phi(), weight, 64, -3.2, 3.2)
                    super().FillHist(f"{self.channel}_{trigSuffix}/loose/{syst}/electrons/{idx}/mass", mu.M(), weight, 10, 0., 1.)
                for idx, jet in enumerate(jets, start=1):
                    super().FillHist(f"{self.channel}_{trigSuffix}/loose/{syst}/jets/{idx}/pt", jet.Pt(), weight, 300, 0., 300.)
                    super().FillHist(f"{self.channel}_{trigSuffix}/loose/{syst}/jets/{idx}/eta", jet.Eta(), weight, 48, -2.4, 2.4)
                    super().FillHist(f"{self.channel}_{trigSuffix}/loose/{syst}/jets/{idx}/phi", jet.Phi(), weight, 64, -3.2, 3.2)
            ...
            if event.PassTrigger("HLT_Ele8_CaloIdL_TrackIdL_IsoVL_PFJet30_v"):
                trigSuffix = "Ele8"
                for idx, mu in enumerate(looseElectrons, start=1):
                    super().FillHist(f"{self.channel}_{trigSuffix}/tight/{syst}/electrons/{idx}/pt", mu.Pt(), weight, 300, 0., 300.)
                    super().FillHist(f"{self.channel}_{trigSuffix}/tight/{syst}/electrons/{idx}/eta", mu.Eta(), weight, 48, -2.4, 2.4)
                    super().FillHist(f"{self.channel}_{trigSuffix}/tight/{syst}/electrons/{idx}/phi", mu.Phi(), weight, 64, -3.2, 3.2)
                    super().FillHist(f"{self.channel}_{trigSuffix}/tight/{syst}/electrons/{idx}/mass", mu.M(), weight, 10, 0., 1.)
                for idx, jet in enumerate(jets, start=1):
                    super().FillHist(f"{self.channel}_{trigSuffix}/tight/{syst}/jets/{idx}/pt", jet.Pt(), weight, 300, 0., 300.)
                    super().FillHist(f"{self.channel}_{trigSuffix}/tight/{syst}/jets/{idx}/eta", jet.Eta(), weight, 48, -2.4, 2.4)
                    super().FillHist(f"{self.channel}_{trigSuffix}/tight/{syst}/jets/{idx}/phi", jet.Phi(), weight, 64, -3.2, 3.2)
