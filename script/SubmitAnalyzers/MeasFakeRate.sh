...
if [[ $ERA == "2016"* ]]; then
    ...
    SKFlat.py -a MeasFakeRateV4 -i WW_pythia                       -n 10 -e $ERA --memory $MEMORY --userflags $CHANNEL,RunSyst --python &
    SKFlat.py -a MeasFakeRateV4 -i WZ_pythia                       -n 10 -e $ERA --memory $MEMORY --userflags $CHANNEL,RunSyst --python &
    SKFlat.py -a MeasFakeRateV4 -i ZZ_pythia                       -n 10 -e $ERA --memory $MEMORY --userflags $CHANNEL,RunSyst --python &
    SKFlat.py -a MeasFakeRateV4 -i SingleTop_sch_Lep               -n 10 -e $ERA --memory $MEMORY --userflags $CHANNEL,RunSyst --python &
    SKFlat.py -a MeasFakeRateV4 -i SingleTop_tch_top_Incl          -n 10 -e $ERA --memory $MEMORY --userflags $CHANNEL,RunSyst --python &
    ...
    SKFlat.py -a MeasFakeRateV4 -i $DATASTREAM                     -n 10 -e $ERA --userflags $CHANNEL,RunSyst --python &
    SKFlat.py -a MeasFakeRateV4 -i TTLJ_powheg                     -n 40 -e $ERA --memory $MEMORY --userflags $CHANNEL,RunSyst --python &
    SKFlat.py -a MeasFakeRateV4 -i TTLL_powheg                     -n 30 -e $ERA --memory $MEMORY --userflags $CHANNEL,RunSyst --python &
    SKFlat.py -a MeasFakeRateV4 -i WJets_MG                        -n 30 -e $ERA --memory $MEMORY --userflags $CHANNEL,RunSyst --python &
    SKFlat.py -a MeasFakeRateV4 -i DYJets                          -n 30 -e $ERA --memory $MEMORY --userflags $CHANNEL,RunSyst --python &
    SKFlat.py -a MeasFakeRateV4 -i DYJets10to50_MG                 -n 10 -e $ERA --memory $MEMORY --userflags $CHANNEL,RunSyst --python &
    SKFlat.py -a MeasFakeRateV4 -i WW_pythia                       -n 20 -e $ERA --memory $MEMORY --userflags $CHANNEL,RunSyst --python &
    SKFlat.py -a MeasFakeRateV4 -i WZ_pythia                       -n 20 -e $ERA --memory $MEMORY --userflags $CHANNEL,RunSyst --python &
    SKFlat.py -a MeasFakeRateV4 -i ZZ_pythia                       -n 20 -e $ERA --memory $MEMORY --userflags $CHANNEL,RunSyst --python &
    SKFlat.py -a MeasFakeRateV4 -i SingleTop_sch_Lep               -n 20 -e $ERA --memory $MEMORY --userflags $CHANNEL,RunSyst --python &
    SKFlat.py -a MeasFakeRateV4 -i SingleTop_tch_top_Incl          -n 20 -e $ERA --memory $MEMORY --userflags $CHANNEL,RunSyst --python &
