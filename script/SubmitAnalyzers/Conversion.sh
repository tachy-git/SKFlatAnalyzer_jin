...
SKFlat.py -a MeasConversion -i tHq -n 10 -e ${ERA} --userflags $CHANNEL  --python &
...
SKFlat.py -a MeasConversion -i WWG -n 10 -e ${ERA} --userflags $CHANNEL  --python &
SKFlat.py -a MeasConversion -i TTG --skim SkimTree_SS2lOR3l -n 10 -e ${ERA} --userflags $CHANNEL  --python &
SKFlat.py -a MeasConversion -i TTTT -n 10 -e ${ERA} --userflags $CHANNEL  --python &
